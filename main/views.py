...
def home(request : HttpRequest) -> HttpResponse:
    if PreviewImage.objects.exists():
        home_image = random.choice(PreviewImage.objects.all())
    else:
        home_image = None
    return render(request, 'home/home.html', {'home_image': home_image})

from django.shortcuts import render
from .models import Contact

def handle_contacts(request):
